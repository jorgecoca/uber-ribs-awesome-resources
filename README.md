# Uber RIBs awesome resources

This is a curated list of resources for the architecture framework created by Uber, called RIBs (Router, Interactor and Builder)

## The framework itself

* [Uber Ribs](https://github.com/uber/RIBs/wiki)
...
* [Uber Architecture Rewrite](https://www.youtube.com/watch?v=bB9e7ZYVYCo)
...
* [Uber Technology Day: Mobile Architecture for Scale](https://www.youtube.com/watch?v=ZTZioPnsJtc)

#### Others

* [RIBs - Uber's new mobile architecture that scales to hundreds of engineers by Tuomas Artman](https://www.youtube.com/watch?v=FfwZSk6VRVY)
* [droidcon SF 2017 - Hot Off the Open-Source Grill: RIBs, Scalable Multiplatform App Architecture by Brian Attwell](https://www.youtube.com/watch?v=yeFgxLWRz6c)
